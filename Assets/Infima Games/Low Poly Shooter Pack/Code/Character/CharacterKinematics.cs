...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CharacterKinematics : MonoBehaviour
    {
        ...
        {
            //TOOD: Write some comments for all this.
            
            float alphaLeft = 1.0f;

            float alphaRight = 1.0f;
            
            if (characterAnimator != null)
            {
                //TODO: Move to hashes.
                //Get Left Constraint Alpha.
                alphaLeft = characterAnimator.GetFloat("Alpha IK Hand Left");
                //Get Right Constraint Alpha.
                alphaRight = characterAnimator.GetFloat("Alpha IK Hand Right");
            }
