...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class LowerWeapon : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            lowered = loweredPressed && !characterBehaviour.IsAiming() && !characterBehaviour.IsRunning()
                && !characterBehaviour.IsInspecting();
            ...
            //Make sure that the equipped weapon has a WeaponAnimationDataBehaviour.
